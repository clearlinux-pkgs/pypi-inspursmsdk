...
Source0  : https://files.pythonhosted.org/packages/1b/04/a3070153257fabcfa4989bc7d68b5e4e0afa2716f1a89ae36a9d8f98dbe4/inspursmsdk-1.4.1.tar.gz
...
%prep
%setup -q -n inspursmsdk-1.4.1
cd %{_builddir}/inspursmsdk-1.4.1
pushd ..
cp -a inspursmsdk-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665066262
